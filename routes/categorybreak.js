...
router.get('/', async(req, res)=>{
    try{
        ...
        res.render('categorybreak/index', { typeleaveList, layout: 'admin_layout'}); 
    }catch(error){
        res.send(error); 
    }
})
...
router.post('/add' , async(req, res) => {
    try{
        ...
        if(err.name === 'ValidationError'){
            ...
            res.render('categorybreak/add', {InputErrors, categorybreak});
        } 
    }
...
router.get('/edit/:id', async(req,res) => {
    ...
    var categorybreak = await CategorybreakModel.findById(id); 
      res.render('categorybreak/edit', {categorybreak}); 
})
...
//                 InputErrors[field] = err.errors[field].message; 
//             }
//             res.render('categorybreak/edit', {InputErrors, categorybreak });
//         } 
//     }
